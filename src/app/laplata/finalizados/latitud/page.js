...
import { latitud_01, latitud_02 } from "../../../../../public/resources/images/laplata";
...
import { Latitud } from "@/components/Svgs";
            ...
            {windowSize.width > 530 ? (
                <div className={style.container}>
                    ...
                    <span>
                        ...
                        <span className={`${style.container__description} description`}>
                            <p>
                                <span>Barrio semi-cerrado ubicado en Los Hornos, a pocos minutos</span>
                                <span>del centro de la ciudad de La Plata.</span>
                            </p>
                ...
                <div className={style.container}>
                    ...
                    <div className={`${style.image_one} image_01`}>
                        <Image src={latitud_01} alt='La Escondida' priority={true} onLoad={() => showFirstImage()} />
                    </div>
            ...
            {windowSize.width > 530 ? (
                <>
                    ...
                    <div className={`${style.image_two} image_02`}>
                        <Image src={latitud_02} alt='La Escondida' priority={true} onLoad={() => showSecondImage()} />
                    </div>
                </>
            ) : (
                <></>

...
import { abastochico_01, abastochico_02 } from "../../../../../public/resources/images/laplata";
import { CallesMejoradas, Luz } from "@/components/Svgs";
import { Button, Tooltip, ButtonAnim } from "@/components";
import { useWindowSize } from "@/hooks/useWindowSize";
import { AbastoChico } from "@/components/Svgs";
            ...
            {windowSize.width > 530 ? (
                <div className={style.container}>
                    ...
                    <span>
                        <span className={`${style.container__logo} logo`}>
                            <AbastoChico fill='#14213d' />
                        </span>

                        <span className={`${style.container__description} description`}>
                            <p>
                                <span>Barrio abierto ubicado en la localidad de Abasto</span>
                                <span>sobre las calles 515 y 168 dentro del partido de La Plata.</span>
                            </p>
                ...
                <div className={style.container}>
                    ...
                    <div className={`${style.image_one} image_01`}>
                        <Image src={abastochico_01} alt='La Escondida' priority={true} onLoad={() => showFirstImage()} />
                    </div>
            ...
            {windowSize.width > 530 ? (
                <>
                    ...
                    <div className={`${style.image_two} image_02`}>
                        <Image src={abastochico_02} alt='La Escondida' priority={true} onLoad={() => showSecondImage()} />
                    </div>
                </>
            ) : (
                <></>

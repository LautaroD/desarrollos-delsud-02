...
import { lasorianas_01, lasorianas_02 } from "../../../../../public/resources/images/laplata";
...
import { LasOrianas } from "@/components/Svgs";
            ...
            {windowSize.width > 530 ? (
                <div className={style.container}>
                    ...
                    <span>
                        <span className={`${style.container__logo} logo`}>
                            <LasOrianas fill='#14213d' width='350' />
                        </span>

                        <span className={`${style.container__description} description`}>
                            <p>
                                <span>Desarrollo ubicado en la localidad de Melchor Romero,</span>
                                <span>dentro del partido de La Plata a sólo 14 min de la Av. 520.</span>
                            </p>
                            <span className={style.container__description__services}>
                                <Tooltip text='Porton de' text2='acceso'>
                ...
                <div className={style.container}>
                    ...
                    <div className={`${style.image_one} image_01`}>
                        <Image src={lasorianas_01} alt='La Escondida' priority={true} onLoad={() => showFirstImage()} />
                    </div>
            ...
            {windowSize.width > 530 ? (
                <>
                    ...
                    <div className={`${style.image_two} image_02`}>
                        <Image src={lasorianas_02} alt='La Escondida' priority={true} onLoad={() => showSecondImage()} />
                    </div>
                </>
            ) : (
                <></>

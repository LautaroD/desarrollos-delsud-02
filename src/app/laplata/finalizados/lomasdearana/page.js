            ...
            {windowSize.width > 530 ? (
                <div className={style.container}>
                    ...
                    <span>
                        <span className={`${style.container__logo} logo`}>
                            <LomasArana fill='#14213d' />
                        </span>

                        <span className={`${style.container__description} description`}>
                            <p>
                                <span>Este barrio semi-cerrado se encuentra ubicado en el corazón </span>
                                <span>de Arana con fácil acceso por Avenida 637.</span>
                            </p>
                ...
                <div className={style.container}>
                    ...
                    <div className={`${style.image_one} image_01`}>
                        <Image src={lomasdearana_01} alt='La Escondida' priority={true} onLoad={() => showFirstImage()} />
                    </div>
            ...
            {windowSize.width > 530 ? (
                <>
                    ...
                    <div className={`${style.image_two} image_02`}>
                        <Image src={lomasdearana_02} alt='La Escondida' priority={true} onLoad={() => showSecondImage()} />
                    </div>
                </>
            ) : (
                <></>

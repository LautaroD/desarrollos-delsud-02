            ...
            {windowSize.width > 530 ? (
                <div className={style.container}>
                    ...
                    <span>
                        ...
                        <span className={`${style.container__description} description`}>
                            <p>
                                <span>Este barrio abierto se encuentra ubicado en la localidad de Abasto</span>
                                <span>en el partido de La Plata sobre las calles 498 y 200.</span>
                            </p>
                ...
                <div className={style.container}>
                    ...
                    <div className={`${style.image_one} image_01`}>
                        <Image src={elcauce_01} alt='La Escondida' priority={true} onLoad={() => showFirstImage()} />
                    </div>
            ...
            {windowSize.width > 530 ? (
                <>
                    ...
                    <div className={`${style.image_two} image_02`}>
                        <Image src={elcauce_02} alt='La Escondida' priority={true} onLoad={() => showSecondImage()} />
                    </div>
                </>
            ) : (
                <></>
